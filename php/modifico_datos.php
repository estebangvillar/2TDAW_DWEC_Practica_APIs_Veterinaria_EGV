...
<body>
    ...
    echo "
        <div class='formulario'>
            ...
            <form name='formulario' action='modifico_datos.php' method='POST' enctype='multipart/form-data'>
                <label for='dni'>DNI: </label>
                <input type='text' name='dni' id='dni' value='$dni' class='readonly' readonly>
                <br>
                <label for='nombre'>Nombre: </label>
                <input type='text' name='nombre' id='nombre' value='$nombre' class='readonly' readonly>
                <br>
                <label for='telefono'>Teléfono: </label>
                <input type='text' name='telefono' id='telefono' value='$telefono' minlength=9 maxlength=9>
                <br>
                <label for='nick'>Nick: </label>
                <input type='text' name='nick' id='nick' value='$nick' class='readonly' readonly>
                <br>
                <label for='pass'>Contraseña: </label>
                <input type='password' name='pass' id='pass' value='$pass'>
                <br>
                <label for='modificar'></label>
                <input type='submit' name='modificar' id='modificar' value='Modificar datos' class='confirmar'>
                <br>
            </form>
        </div>
    ";
    ...
    if (isset($_POST["modificar"])) {
        ...
        if ($resultado == true) {
            ...
            header("refresh:1.5;url=mis_datos.php");
        } else {
